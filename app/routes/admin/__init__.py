...
Varje submodul hanterar ett ansvarsområde:
  ...
  snabblänkar.py  — snabblänkar på startsidan (featured links)
...
from . import bundles, links, settings, snabblänkar, stats, takeovers, users
...
router.include_router(snabblänkar.router)
